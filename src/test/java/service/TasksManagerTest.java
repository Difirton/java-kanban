...
abstract class TasksManagerTest<T extends TasksManager> {
    ...
    public void testGetEpicBySubtaskId() {
        long actual = inMemoryTaskManager.getEpicBySubtaskId(3L).getId();
        long expected = 1L;
        assertEquals(actual, expected);
    }
    ...
    public void testChangeSubtaskStatusInProgress() {
        ...
        TaskStatus actual = inMemoryTaskManager.getEpicBySubtaskId(2L).getStatus();
    ...
    public void testChangeSubtaskStatusDone() {
        ...
        TaskStatus actual = inMemoryTaskManager.getSubtaskById(4L).getStatus();
    ...
    public void testUpdateEpicName() {
        inMemoryTaskManager.updateTaskName(1L, "New Name");
    ...
    public void testUpdateEpicDescription() {
        inMemoryTaskManager.updateTaskDescription(5L, "New Description");
    ...
    public void testTasksQueue() {
        ...
        inMemoryTaskManager.getSubtaskById(3L);
        inMemoryTaskManager.getEpicById(5L);
    ...
    public void testSizeHistoryToOneTask() {
        inMemoryTaskManager.getSubtaskById(2L);
        inMemoryTaskManager.getSubtaskById(2L);
        inMemoryTaskManager.getSubtaskById(2L);
        inMemoryTaskManager.getSubtaskById(2L);
        inMemoryTaskManager.getSubtaskById(2L);
